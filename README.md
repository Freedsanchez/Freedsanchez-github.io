...
<head>
    ...
    <style>
        ...
        .contact-info, .education, .family, .hobbies, .favorite-places {
            margin-bottom: 20px;
        }
        img {
            max-width: 100%;
...
<body>
    ...
    <img src="https://via.placeholder.com/600x400" alt="Fotografía de naturaleza">
    <img src="https://via.placeholder.com/600x400" alt="Paisaje natural">
